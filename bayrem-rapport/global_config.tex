...
\title{Système de Location en Ligne avec Interaction Multi-Utilisateurs et Gestion Dynamique des Réservations}

\author{BOUSSAIDI Bayrem}
%%% if necessary
...
\proFramerName{M. ZELLIT Mootaz}
\proFramerSpeciality{Ingénieur Informatique}

%% Encadrant académique
\academicFramerName{Mme. JALEL Sawsen}
\academicFramerSpeciality{Poste}

%% Entreprise d'accueil
\companyName{Global Enr}
